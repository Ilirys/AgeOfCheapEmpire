...
class Game:
    ...
    def __init__(self, screen, clock):
        ...
        #ArcherIA(self.world.world[20][3], self.world, self.camera,self.IA)
        #HorsemanIA(self.world.world[14][24], self.world, self.camera,self.IA)
        #SoldierIA(self.world.world[3][3], self.world, self.camera, self.IA)
        #ArcherIA(self.world.world[0][3], self.world, self.camera, self.IA)
